...
public class Six extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://webviewpostbd.blogspot.com/search/label/Six?&max-results=100&m=1");
                    ...
                    .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            if(URLUtil.isValidUrl(DownloadImageURL)){
                                ...
                                Toast.makeText(Six.this,"Image Downloaded Successfully...",Toast.LENGTH_LONG).show();
                            }
                            else {
                                Toast.makeText(Six.this,"Sorry.. Something Went Wrong...",Toast.LENGTH_LONG).show();
                            }
                            return false;
                        }
                    });
