...
public class Twelve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://webviewpostbd.blogspot.com/search/label/Twelve?&max-results=100&m=1");
                    ...
                    .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            if(URLUtil.isValidUrl(DownloadImageURL)){
                                ...
                                Toast.makeText(Twelve.this,"Image Downloaded Successfully...",Toast.LENGTH_LONG).show();
                            }
                            else {
                                Toast.makeText(Twelve.this,"Sorry.. Something Went Wrong...",Toast.LENGTH_LONG).show();
                            }
                            return false;
                        }
                    });
