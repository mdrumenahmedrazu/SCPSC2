...
public class Seven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://webviewpostbd.blogspot.com/search/label/Seven?&max-results=100&m=1");
                    ...
                    .setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            if(URLUtil.isValidUrl(DownloadImageURL)){
                                ...
                                Toast.makeText(Seven.this,"Image Downloaded Successfully...",Toast.LENGTH_LONG).show();
                            }
                            else {
                                Toast.makeText(Seven.this,"Sorry.. Something Went Wrong...",Toast.LENGTH_LONG).show();
                            }
                            return false;
                        }
                    });
